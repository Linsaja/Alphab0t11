...
zeksApikey = 'dhavaApii' //ganti pake apikey lu biar limitnya gk cepet abis 
...
img = setting.img
baper = 'FOLLOW IG DRAX NOTHING'
apiku = 'https://instagram.com/drax_nothing'
gc_wa_lu = 'https://chat.whatsapp.com/Lfbd0jm6j5qGOK6LJPkkjm' //klo gk punya gc wa gk usah di ganti 👍
...
const bayarLimit = (sender, amount) => {
	...
	//FUCNTION GOPLANET BY RIPAI
	   ...
	   //FUCNTION mining coal
        ...
        if(time2 < "23:59:00"){
        var ucapannya2 = `Night lord 🌚 ${pushname}`
}
        if(time2 < "19:00:00"){
        var ucapannya2 = `Night lord 🌚 ${pushname}`
}
        if(time2 < "18:00:00"){
        var ucapannya2 = `Afternoon lord 🌅 ${pushname}`
}
        if(time2 < "15:00:00"){
        var ucapannya2 = `GoodDay lord 🌞 ${pushname}`
}
        if(time2 < "11:00:00"){
        var ucapannya2 = `Morning lord 🌄 ${pushname}`
}
        if(time2 < "05:00:00"){
        var ucapannya2 = `Night lord 🌚 ${pushname}`
}
